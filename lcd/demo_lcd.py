...
# Modified by Derek Georgevich, created by Matthew Timmons-Brown.
...
try:
    while True:
        ...
        display.lcd_display_string("World", 2)  # Write line of text to second line of display
        time.sleep(4)                                     # Give time for the message to be read
        display.lcd_clear()                               # Clear the display of any data       
        display.lcd_display_string("Goodbye World", 1)    # Refresh the first line of display with a different message
        time.sleep(4)                                     # Give time for the message to be read
        display.lcd_clear()                               # Clear the display of any data
